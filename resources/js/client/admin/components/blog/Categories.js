...
const Categories = () => {
    ...
    const showConfirm = (rows) => {
        ...
        confirm({
            ...
            onOk() {
                setLoading(true);
                HTTP.delete(Routes.api.admin.blogCategories, {
                    params: {
                        ids: ids
                    }
                })
    ...
    return (
        <React.Fragment>
                ...
                <PageHeader
                    ...
                    subTitle={
                        <Typography.Text
                            ...
                            ellipsis={{ tooltip: 'Organize posts by category' }}
                        >
                ...
                >
                    <ProTable
                        ...
                        request={async (params, sorter) => {
                            return HTTP.get(Routes.api.admin.blogCategories+'?page='+params.current, {
                                params: {
                                    params,
                                    sorter,
                                    columns
            ...
            </PageWrapper>
            {
                modalVisible && (
                    <Category
                        title={itemToEdit ? 'Edit Category' : 'Add Category'}
